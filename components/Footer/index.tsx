            ...
            <div className="section-container">
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <p style={{ fontSize: "13px", color: "var(--text-muted)", maxWidth: "340px", lineHeight: 1.75 }}>
                            Building intelligent systems at the intersection of AI, data, and high-performance engineering.
                        </p>
                    </div>
                ...
                <div style={{
                    ...
                    <div style={{ fontSize: "12px", color: "var(--text-muted)", fontFamily: "'Inter', sans-serif" }}>
                        © 2026 Priyanshu Shukla. All rights reserved.
                    </div>
